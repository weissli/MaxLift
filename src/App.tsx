...
export const CATEGORIES = ['All', 'Chest', 'Back', 'Legs', 'Shoulders', 'Arms', 'Core', 'Cardio', 'Other'];
...
export const DEFAULT_EXERCISES = [
  ...
  { id: 'c4', name: 'Dumbbell bench press', category: 'Chest', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  ...
  { id: 'b4', name: 'Lat Pulldown', category: 'Back', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 'b5', name: 'Chest support row', category: 'Back', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 'b6', name: 'Banded row', category: 'Back', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 'l1', name: 'Back Squat', category: 'Legs', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 'l2', name: 'Front Squat', category: 'Legs', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 'l3', name: 'Romanian Deadlift', category: 'Legs', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 'l4', name: 'Bulgarian Split Squat', category: 'Legs', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 'l5', name: 'Leg Press', category: 'Legs', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 'l6', name: 'Trap bar deadlift', category: 'Legs', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 'l7', name: 'Walking lunge', category: 'Legs', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 'l8', name: 'Front rack Front foot elevated split squat', category: 'Legs', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 'l9', name: 'Zercher reverse lunge', category: 'Legs', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 'l10', name: 'Leg extensions ', category: 'Legs', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 'l11', name: 'Step up', category: 'Legs', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 'l12', name: 'Goblet squat', category: 'Legs', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 's1', name: 'Overhead Press (Military)', category: 'Shoulders', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 's2', name: 'Seated Dumbbell Press', category: 'Shoulders', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 's3', name: 'Lateral Raise', category: 'Shoulders', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 's4', name: 'Banded chop', category: 'Shoulders', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 's5', name: 'Single arm lat pulldown ', category: 'Shoulders', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 's6', name: 'Single arm overhead carry', category: 'Shoulders', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 's7', name: 'Kettle bell row from step', category: 'Shoulders', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 'a1', name: 'Barbell Bicep Curl', category: 'Arms', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 'a2', name: 'Tricep Pushdown', category: 'Arms', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 'a3', name: 'Single arm overhead press', category: 'Arms', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 'a4', name: 'Standing dumbbell overhead press', category: 'Arms', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 'a5', name: 'Dumbbell row', category: 'Arms', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 'co1', name: 'Body saw', category: 'Core', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 'co2', name: 'Pallof press', category: 'Core', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
  { id: 'o1', name: 'Press-Ups (Push-Ups)', category: 'Other', currentWeight: 0, maxWeight: 0, unit: 'reps', date: null, history: [] }, 
  { id: 'o2', name: 'Single leg RDL', category: 'Other', currentWeight: 0, maxWeight: 0, unit: 'kg', date: null, history: [] },
];
...
function ExerciseCard({ exercise, onClick }: { exercise: any, onClick: () => void }) {
    ...
    return (
        <div data-testid="exercise-card" onClick={onClick} className="bg-slate-800/50 border border-slate-800 p-4 rounded-2xl flex items-center justify-between active:scale-95 transition-all cursor-pointer">
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
            <div className="bg-slate-800 w-full max-w-xs rounded-2xl border border-slate-700 p-6 shadow-2xl">
               ...
               <div className="flex gap-3">
                    ...
                    <button data-testid="confirm-delete-btn" onClick={onConfirm} className="flex-1 py-3 rounded-xl font-bold text-white bg-red-600 outline-none">Delete</button>
               </div>
            </div>
        </div>
    );
            ...
            {!showHistory ? (
              <>
                ...
                <div className="flex flex-col gap-3">
                    <div className="flex gap-3">
                        <button data-testid="delete-exercise-btn" onClick={() => onDeleteRequest(exercise.id)} className="flex-1 py-4 rounded-xl font-bold text-red-400 bg-red-900/10 active:bg-red-900/20 outline-none">Delete</button>
                        <button data-testid="save-log-btn" onClick={() => onSave(exercise.id, value, unit)} className="flex-[2] py-4 rounded-xl font-bold text-white bg-blue-600 active:bg-blue-700 flex items-center justify-center gap-2 outline-none">
                            <Save size={20}/> Save Log
                        </button>
                    </div>
                    <button data-testid="view-history-btn" onClick={() => setShowHistory(true)} className="w-full py-3 rounded-xl font-bold text-slate-400 bg-slate-800 flex items-center justify-center gap-2 text-sm active:bg-slate-700 outline-none">
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div className="bg-slate-900 w-full max-w-sm rounded-3xl border border-slate-800 p-6 shadow-2xl">
        ...
        <input data-testid="exercise-name-input" type="text" value={name} onChange={e => setName(e.target.value)} placeholder="Exercise name..." className="w-full bg-slate-800 text-white p-4 rounded-xl mb-4 border-2 border-transparent focus:border-blue-600 outline-none" />
        ...
        <button data-testid="create-exercise-btn" onClick={() => onAdd(name, category, unit)} disabled={!name} className="w-full py-4 rounded-xl font-bold text-white bg-blue-600 disabled:opacity-50 active:bg-blue-700 outline-none">Create</button>
      </div>
    </div>
  );
}

function InstallBanner({ onClose, onInstall, isIOS, hasPrompt }: { onClose: () => void, onInstall: () => void, isIOS: boolean, hasPrompt: boolean }) {
    const getMessage = () => {
        if (isIOS) {
        ...
        return "Tap the menu button and 'Add to Home screen'";
    };

    return (
        <div className="fixed top-0 left-0 right-0 z-[100] p-4 bg-slate-800 border-b border-slate-700 shadow-2xl">
            <div className="max-w-md mx-auto flex items-center justify-between gap-4">
                <div className="flex-1">
                    <h3 className="text-white font-bold text-sm">Install MaxLift</h3>
                ...
                <div className="flex items-center gap-2">
                    {!isIOS && hasPrompt && (
                        <button onClick={onInstall} className="bg-blue-600 text-white px-4 py-2 rounded-xl text-xs font-bold active:scale-95 transition-all outline-none">Install</button>
                    )}
                    <button onClick={onClose} className="text-slate-500 p-2 active:bg-slate-700 rounded-full outline-none"><X size={20} /></button>
                </div>
            </div>
        </div>
    );
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const dismissed = localStorage.getItem('maxlift_install_dismissed');
  ...
  const handleCloseBanner = () => {
    localStorage.setItem('maxlift_install_dismissed', 'true');
    setShowInstallBanner(false);
  };
  ...
  return (
    <div className="max-w-md mx-auto h-full flex flex-col relative overflow-hidden">
      <header className="sticky top-0 z-30 bg-slate-900/95 backdrop-blur-md p-4 space-y-4 border-b border-slate-800 shrink-0">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-2">
              ...
              <button data-testid="add-exercise-btn" onClick={() => setIsAddModalOpen(true)} className="p-2 bg-blue-600 text-white rounded-full active:scale-95 outline-none"><Plus size={24}/></button>
          </div>
        </div>
      ...
      {showInstallBanner && <InstallBanner onClose={handleCloseBanner} onInstall={handleInstall} isIOS={isIOS} hasPrompt={!!deferredPrompt} />}
    </div>
  );
}
